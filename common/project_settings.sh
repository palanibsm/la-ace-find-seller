...
PROJECT_NAME="find-seller-app-senthil"
...
PUBLIC_ASSETS="fs-sen-dev-public-bucket"

# This is the Storage bucket used for private assets. 
# The entire bucket is private by default
PRIVATE_ASSETS="fs-sen-dev-private-bucket"

# The name of the Pubsub topic to create / use
PUB_SUB_TOPIC="fs-sen-dev-items"

# The name of the custom network for the product and ads services
SERVICES_NETWORK="fs-sen-dev-app-network"

# The name of the product service subnet
PRODUCT_SUBNET="fs-sen-dev-prod-app-network-subnet"

# The name of the product service subnet
ADS_SUBNET="fs-sen-dev-ad-app-network-subnet"

# The name of the Kubernetes cluster used for the products service
PRODUCT_CLUSTER_NAME="fs-sen-dev-app-clusters"

# The name of the spanner instance
PRODUCT_DB_INSTANCE_NAME="fs-sen-dev-app-spanner-instance"

# The name of the spanner db
PRODUCT_DB_NAME="fs-sen-dev-app-spanner-db"
...
FUNCTION_NAME="fs-sen-dev-upload"
